...
pub const missing_credential_message = "Fx needs authentication. Run fx login to sign in (with FX_OAUTH_ISSUER_URL and FX_OAUTH_CLIENT_ID), fx setup to use an API key, or set AI_GATEWAY_API_KEY.";
pub const missing_interactive_credential_message = "Fx needs authentication. Run /login to sign in (with FX_OAUTH_ISSUER_URL and FX_OAUTH_CLIENT_ID), /setup to use an API key, or set AI_GATEWAY_API_KEY.";
