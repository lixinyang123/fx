...
pub const top_level_specs = [_]TopLevelSpec{
    ...
    .{
        ...
        .token = "logout",
        .usage = "logout",
        .summary = "Sign out of the current OAuth session",
    },
    .{
        .kind = .setup,
        .token = "setup",
...
pub const slash_specs = [_]SlashSpec{
    ...
    .{ .kind = .login, .command = "/login", .help_entry = "/login", .completion_description = "sign in with an OAuth provider", .presentation_category = .account },
